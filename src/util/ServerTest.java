...
public class ServerTest {
    ...
    public static void main(String args[]) throws IOException, ClassNotFoundException {
        ...
        Books dummy = new Books("T-Title","T-ISBN","T-Author","T-Genre",
			"T-Date","http://pythoniza.me/wp-content/uploads/2014/10/ibHNQU.png",
			"T-Publisher","T-Info");
        
        dummyOutput.writeObject(new Reply<String>(Reply.TypeReply.BOOK, 
			"http://pythoniza.me/wp-content/uploads/2014/10/ibHNQU.png"));
    }
}
